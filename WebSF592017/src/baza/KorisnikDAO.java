...
public class KorisnikDAO {
	...
	public static Korisnik getPrijavljen(String korime) {
		...
		ResultSet rset = null;
		try {
			String query = "SELECT korime, lozinka, datumRegistracije, uloga, aktivan FROM korisnici WHERE korime = ? AND aktivan = 1";
